...
[Migration("20251121125224_TransactionApiKey")]
partial class TransactionApiKey
{
    /// <inheritdoc />
...
#pragma warning disable 612, 618
        ...
        modelBuilder.Entity("CryptoOnRamp.DAL.Models.TelegramUserDb", b =>
            {
                ...
                b.ToTable("TelegramUsers", "public");
            });
        ...
        modelBuilder.Entity("CryptoOnRamp.DAL.Models.TransactionDb", b =>
            {
                ...
                b.Property<string>("ContractApiKey")
                    .HasColumnType("text");

                b.Property<Guid?>("ContractUniqueId")
                    .HasColumnType("uuid");
        ...
        modelBuilder.Entity("CryptoOnRamp.DAL.Models.UserDb", b =>
            {
                ...
                b.Property<string>("WebhookAuthorizationToken")
                    .HasColumnType("text")
        ...
        modelBuilder.Entity("CryptoOnRamp.DAL.Models.TransactionDb", b =>
            {
                b.HasOne("CryptoOnRamp.DAL.Models.UserDb", "User")
                    .WithMany()
                    .HasForeignKey("UserId")
                    .OnDelete(DeleteBehavior.Cascade)
                    .IsRequired();
